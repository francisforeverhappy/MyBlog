...
import com.francislzf.blog.service.VisitorInfoService;
import com.francislzf.blog.utils.IpToAddressUtil;
...
public class VisitorInfoAspect {
    ...
    @Pointcut("execution(* com.francislzf.blog.controller.*.*(..))") //记录下访问者在首页的一些操作
